...
- **Verify your fix PR passes CI** (step 5e)

**Never push code that doesn't pass lint. Never leave broken PRs.**
...
### 5e. Verify CI passes
After pushing, verify your PR passes CI:
